...
public class DetailFragment extends Fragment {
    ...
    private void done() {
        ...
        personBean.setFirstName(mEtFirstName.getText().toString());
        personBean.setLastName(mEtLastName.getText().toString());
        personBean.setAge(Integer.valueOf(mEtAge.getText().toString()));

        mListener.onDetailFragmentFinish(personBean);
    }
    ...
    public interface DetailFragmentListener {
        void onDetailFragmentFinish(PersonBean personBean);
    }
