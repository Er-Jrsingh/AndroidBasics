...
public class MainActivity extends AppCompatActivity
    ...
    @Override
    public void onDetailFragmentFinish(PersonBean personBean) {

        OutputFragment fragment = (OutputFragment) getSupportFragmentManager()
                .findFragmentByTag(FRAGMENT_TAG);

        fragment.displayPerson(personBean);

        Log.d("MyTag", "onDetailFragmentFinish: PersonBean: " + personBean.toString());
    }
}
